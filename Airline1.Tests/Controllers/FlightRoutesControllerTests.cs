...
namespace Airline1.Tests.Controllers
{
    public class FlightRoutesControllerTests
    {
        ...
        public async Task Create_ReturnsCreatedAtAction_WhenValid()
        {
            ...
            var response = new FlightRouteResponse { Id = 1 };
        ...
        {
            var list = new List<FlightRouteResponse> { new FlightRouteResponse() };
        ...
        {
            _mockService.Setup(s => s.GetByIdAsync(1)).ReturnsAsync((FlightRouteResponse)null);
        ...
        {
            var request = new UpdateFlightRouteRequest();
            _mockService.Setup(s => s.UpdateAsync(1, request)).ReturnsAsync((FlightRouteResponse)null);
