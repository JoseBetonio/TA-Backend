...
namespace Airline1.Tests.Controllers
{
    public class AirportsControllerTests
    {
        ...
        public async Task Create_ReturnsCreatedAtAction_WhenValid()
        {
            ...
            var response = new AirportResponse { Id = 1 };
        ...
        {
            var list = new List<AirportResponse> { new AirportResponse() };
        ...
        {
            _mockService.Setup(s => s.GetByIdAsync(1)).ReturnsAsync((AirportResponse)null);
        ...
        {
            var request = new UpdateAirportRequest();
            _mockService.Setup(s => s.UpdateAsync(1, request)).ReturnsAsync((AirportResponse)null);
